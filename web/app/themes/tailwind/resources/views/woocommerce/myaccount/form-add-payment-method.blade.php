...
if ( $available_gateways ) : ?>
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment space-y-6">
			...
			<div class="flex justify-end">
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt sm:w-auto" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></button>
			</div>
		</div>
	</form>
<?php else : ?>
