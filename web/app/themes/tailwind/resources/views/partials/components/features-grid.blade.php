...
<div class="relative bg-white py-16 sm:py-24 lg:py-32">
    <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 class="text-base font-semibold uppercase tracking-wider text-primary-500">Deploy faster</h2>
        <p class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Everything you need to deploy
            your app</p>
                        ...
                        <div class="-mt-6">
                            <div>
                                <span
                                    ...
                                    {{-- @todo Create a custom rounded box with color and text coming from ACF and replace this svg. --}}
                                </span>
                            </div>
                            <h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">Push to Deploy</h3>
                            {{-- @todo Align this to the right and make it a list. --}}
                            <p class="mt-5 text-base text-gray-500">Ac tincidunt sapien vehicula erat auctor
